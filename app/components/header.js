                                        ...
                                        <ul className="dropdown-menu-list scroller" style={{height: 275}} data-handle-color="#637283">
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.4}} className="progress-bar progress-bar-success" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.65}} className="progress-bar progress-bar-danger" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.98}} className="progress-bar progress-bar-success" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.10}} className="progress-bar progress-bar-warning" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.58}} className="progress-bar progress-bar-info" aria-valuenow="58" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress">
                                                        <span style={{flex: 0.85}} className="progress-bar progress-bar-success" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
                                            ...
                                            <li>
                                                <a href="javascript:;">
                                                    ...
                                                    <span className="progress progress-striped">
                                                        <span style={{flex: 0.38}} className="progress-bar progress-bar-important" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100">
